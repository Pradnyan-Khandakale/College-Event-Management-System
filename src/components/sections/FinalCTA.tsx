  ...
  return (
    <section className="py-24 relative overflow-hidden px-6">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="relative rounded-3xl border border-purple-500/20 bg-slate-950/80 p-8 sm:p-16 text-center overflow-hidden shadow-2xl backdrop-blur-2xl">
          {/* Grid background overlay */}
          <div className="dot-bg opacity-30" />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-purple-500/20 bg-purple-500/5 text-purple-300 text-xs sm:text-sm font-semibold mb-8 backdrop-blur-md relative z-10"
          >
          ...
          {/* Headline */}
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white max-w-3xl mx-auto leading-[1.1] relative z-10">
            Launch Your Next <br />
          ...
          {/* Subtext */}
          <p className="text-slate-400 text-sm sm:text-base max-w-xl mx-auto mt-6 leading-relaxed relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-10 w-full sm:w-auto relative z-10">
            ...
            <Button variant="outline" size="lg" className="w-full sm:w-auto gap-2">
              <Calendar className="w-4.5 h-4.5 text-cyan-400" /> Schedule Demo
            </Button>
          </div>
        </div>
      </div>
